    ...
    public function run()
    {
        ...
        if ($skincare) {
            ...
            foreach ($skincareProducts as [$name, $price, $stock, $desc]) {
                $slug = Str::slug($name); $ext = file_exists(public_path("images/skincare/{$slug}.jpg")) ? 'jpg' : 'jpeg'; $img = "/images/skincare/{$slug}.{$ext}";
                Product::create(['name' => $name, 'price' => $price, 'stock' => $stock, 'subcategory_id' => $skincare->id, 'image_url' => $img, 'description' => $desc]);
            }
        }
        ...
        if ($makeup) {
            ...
            foreach ($makeupProducts as [$name, $price, $stock, $desc]) {
                $slug = Str::slug($name); $ext = file_exists(public_path("images/makeup/{$slug}.jpg")) ? 'jpg' : 'jpeg'; $img = "/images/makeup/{$slug}.{$ext}";
                Product::create(['name' => $name, 'price' => $price, 'stock' => $stock, 'subcategory_id' => $makeup->id, 'image_url' => $img, 'description' => $desc]);
            }
        }
        ...
        if ($parfum) {
            ...
            foreach ($parfumProducts as [$name, $price, $stock, $desc]) {
                $slug = Str::slug($name); $ext = file_exists(public_path("images/parfum/{$slug}.jpg")) ? 'jpg' : 'jpeg'; $img = "/images/parfum/{$slug}.{$ext}";
                Product::create(['name' => $name, 'price' => $price, 'stock' => $stock, 'subcategory_id' => $parfum->id, 'image_url' => $img, 'description' => $desc]);
            }
        }
        ...
        if ($sabun) {
            ...
            foreach ($sabunProducts as [$name, $price, $stock, $desc]) {
                $slug = Str::slug($name); $ext = file_exists(public_path("images/sabun/{$slug}.jpg")) ? 'jpg' : 'jpeg'; $img = "/images/sabun/{$slug}.{$ext}";
                Product::create(['name' => $name, 'price' => $price, 'stock' => $stock, 'subcategory_id' => $sabun->id, 'image_url' => $img, 'description' => $desc]);
            }
        }
        ...
        if ($shampoo) {
            ...
            foreach ($shampooProducts as [$name, $price, $stock, $desc]) {
                $slug = Str::slug($name); $ext = file_exists(public_path("images/shampoo/{$slug}.jpg")) ? 'jpg' : 'jpeg'; $img = "/images/shampoo/{$slug}.{$ext}";
                Product::create(['name' => $name, 'price' => $price, 'stock' => $stock, 'subcategory_id' => $shampoo->id, 'image_url' => $img, 'description' => $desc]);
            }
        }
        ...
        if ($body_lotion) {
            ...
            foreach ($bodyLotionProducts as [$name, $price, $stock, $desc]) {
                $slug = Str::slug($name); $ext = file_exists(public_path("images/body-lotion/{$slug}.jpg")) ? 'jpg' : 'jpeg'; $img = "/images/body-lotion/{$slug}.{$ext}";
                Product::create(['name' => $name, 'price' => $price, 'stock' => $stock, 'subcategory_id' => $body_lotion->id, 'image_url' => $img, 'description' => $desc]);
            }
        }
        ...
        if ($lipstick) {
            ...
            foreach ($lipstickProducts as [$name, $price, $stock, $desc]) {
                $slug = Str::slug($name); $ext = file_exists(public_path("images/lipstick/{$slug}.jpg")) ? 'jpg' : 'jpeg'; $img = "/images/lipstick/{$slug}.{$ext}";
                Product::create(['name' => $name, 'price' => $price, 'stock' => $stock, 'subcategory_id' => $lipstick->id, 'image_url' => $img, 'description' => $desc]);
            }
        }
        ...
        if ($masker_wajah) {
            ...
            foreach ($maskerWajahProducts as [$name, $price, $stock, $desc]) {
                $slug = Str::slug($name); $ext = file_exists(public_path("images/masker-wajah/{$slug}.jpg")) ? 'jpg' : 'jpeg'; $img = "/images/masker-wajah/{$slug}.{$ext}";
                Product::create(['name' => $name, 'price' => $price, 'stock' => $stock, 'subcategory_id' => $masker_wajah->id, 'image_url' => $img, 'description' => $desc]);
            }
        }
        ...
        if ($eyebrow) {
            ...
            foreach ($eyebrowProducts as [$name, $price, $stock, $desc]) {
                $slug = Str::slug($name); $ext = file_exists(public_path("images/eyebrow/{$slug}.jpg")) ? 'jpg' : 'jpeg'; $img = "/images/eyebrow/{$slug}.{$ext}";
                Product::create(['name' => $name, 'price' => $price, 'stock' => $stock, 'subcategory_id' => $eyebrow->id, 'image_url' => $img, 'description' => $desc]);
            }
        }
        ...
        if ($foundation) {
            ...
            foreach ($foundationProducts as [$name, $price, $stock, $desc]) {
                $slug = Str::slug($name); $ext = file_exists(public_path("images/foundation/{$slug}.jpg")) ? 'jpg' : 'jpeg'; $img = "/images/foundation/{$slug}.{$ext}";
                Product::create(['name' => $name, 'price' => $price, 'stock' => $stock, 'subcategory_id' => $foundation->id, 'image_url' => $img, 'description' => $desc]);
            }
        }

                // =======================================================
        // === PRODUK KATEGORI HOBI (LENGKAP) ===
        // =======================================================
        ...
        if ($game) {
            ...
            foreach ($gameProducts as [$name, $price, $stock, $desc]) {
                $slug = Str::slug($name); $ext = file_exists(public_path("images/game/{$slug}.jpg")) ? 'jpg' : 'jpeg'; $img = "/images/game/{$slug}.{$ext}";
                Product::create(['name' => $name, 'price' => $price, 'stock' => $stock, 'subcategory_id' => $game->id, 'image_url' => $img, 'description' => $desc]);
            }
        }
        ...
        if ($puzzle) {
            ...
            foreach ($puzzleProducts as [$name, $price, $stock, $desc]) {
                $slug = Str::slug($name); $ext = file_exists(public_path("images/puzzle/{$slug}.jpg")) ? 'jpg' : 'jpeg'; $img = "/images/puzzle/{$slug}.{$ext}";
                Product::create(['name' => $name, 'price' => $price, 'stock' => $stock, 'subcategory_id' => $puzzle->id, 'image_url' => $img, 'description' => $desc]);
            }
        }
        ...
        if ($model_kit) {
            ...
            foreach ($modelKitProducts as [$name, $price, $stock, $desc]) {
                $slug = Str::slug($name); $ext = file_exists(public_path("images/model-kit/{$slug}.jpg")) ? 'jpg' : 'jpeg'; $img = "/images/model-kit/{$slug}.{$ext}";
                Product::create(['name' => $name, 'price' => $price, 'stock' => $stock, 'subcategory_id' => $model_kit->id, 'image_url' => $img, 'description' => $desc]);
            }
        }
        ...
        if ($buku) {
            ...
            foreach ($bukuProducts as [$name, $price, $stock, $desc]) {
                $slug = Str::slug($name); $ext = file_exists(public_path("images/buku/{$slug}.jpg")) ? 'jpg' : 'jpeg'; $img = "/images/buku/{$slug}.{$ext}";
                Product::create(['name' => $name, 'price' => $price, 'stock' => $stock, 'subcategory_id' => $buku->id, 'image_url' => $img, 'description' => $desc]);
            }
        }
        ...
        if ($alat_musik) {
            ...
            foreach ($alatMusikProducts as [$name, $price, $stock, $desc]) {
                $slug = Str::slug($name); $ext = file_exists(public_path("images/alat-musik/{$slug}.jpg")) ? 'jpg' : 'jpeg'; $img = "/images/alat-musik/{$slug}.{$ext}";
                Product::create(['name' => $name, 'price' => $price, 'stock' => $stock, 'subcategory_id' => $alat_musik->id, 'image_url' => $img, 'description' => $desc]);
            }
        }
        ...
        if ($drone) {
            ...
            foreach ($droneProducts as [$name, $price, $stock, $desc]) {
                $slug = Str::slug($name); $ext = file_exists(public_path("images/drone/{$slug}.jpg")) ? 'jpg' : 'jpeg'; $img = "/images/drone/{$slug}.{$ext}";
                Product::create(['name' => $name, 'price' => $price, 'stock' => $stock, 'subcategory_id' => $drone->id, 'image_url' => $img, 'description' => $desc]);
            }
        }
        ...
        if ($kamera_analog) {
            ...
            foreach ($kameraAnalogProducts as [$name, $price, $stock, $desc]) {
                $slug = Str::slug($name); $ext = file_exists(public_path("images/kamera-analog/{$slug}.jpg")) ? 'jpg' : 'jpeg'; $img = "/images/kamera-analog/{$slug}.{$ext}";
                Product::create(['name' => $name, 'price' => $price, 'stock' => $stock, 'subcategory_id' => $kamera_analog->id, 'image_url' => $img, 'description' => $desc]);
            }
        }
        ...
        if ($kartu_koleksi) {
            ...
            foreach ($kartuKoleksiProducts as [$name, $price, $stock, $desc]) {
                $slug = Str::slug($name); $ext = file_exists(public_path("images/kartu-koleksi/{$slug}.jpg")) ? 'jpg' : 'jpeg'; $img = "/images/kartu-koleksi/{$slug}.{$ext}";
                Product::create(['name' => $name, 'price' => $price, 'stock' => $stock, 'subcategory_id' => $kartu_koleksi->id, 'image_url' => $img, 'description' => $desc]);
            }
        }
        ...
        if ($kerajinan) {
            ...
            foreach ($kerajinanProducts as [$name, $price, $stock, $desc]) {
                $slug = Str::slug($name); $ext = file_exists(public_path("images/kerajinan/{$slug}.jpg")) ? 'jpg' : 'jpeg'; $img = "/images/kerajinan/{$slug}.{$ext}";
                Product::create(['name' => $name, 'price' => $price, 'stock' => $stock, 'subcategory_id' => $kerajinan->id, 'image_url' => $img, 'description' => $desc]);
            }
        }
        ...
        if ($lego) {
            ...
            foreach ($legoProducts as [$name, $price, $stock, $desc]) {
                $slug = Str::slug($name); $ext = file_exists(public_path("images/lego/{$slug}.jpg")) ? 'jpg' : 'jpeg'; $img = "/images/lego/{$slug}.{$ext}";
                Product::create(['name' => $name, 'price' => $price, 'stock' => $stock, 'subcategory_id' => $lego->id, 'image_url' => $img, 'description' => $desc]);
            }
        }
